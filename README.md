...
- **W3** — 테마 토글, 라우트별 SEO 메타, Figure 컴포넌트, robots/sitemap, 파비콘
- **W4** — `/about` 페이지 (지금 / 일하는 방식 / 이력 / 연락), 헤더 nav 활성 상태 ← 현재
- 본문 채우기 (자기소개·이력·인터뷰·지표·이미지) — 자기 페이스로
